// ——————————————————————————————
// LANGUAGE SWITCHER (Arabic ↔ English) — FINAL & PERFECT
// ——————————————————————————————
const translations = {
    en: {
...
// ——————————————————————————————
// زر تبديل اللغة في أسفل الشاشة في المنتصف (جميل وثابت)
// ——————————————————————————————
document.addEventListener('DOMContentLoaded', () => {
    // إزالة الزر القديم إذا كان موجود
    const oldBtn = document.getElementById('langToggle');
    if (oldBtn) oldBtn.remove();

    // إنشاء زر جديد في أسفل الشاشة في المنتصف
    const langBtn = document.createElement('button');
    langBtn.id = 'langToggle';
    langBtn.innerHTML = currentLang === 'en' ? 'العربية' : 'English';
    ...
    langBtn.addEventListener('mouseover', () => {
        langBtn.style.transform = 'translateX(-50%) scale(1.05)';
    });
    langBtn.addEventListener('mouseout', () => {
        langBtn.style.transform = 'translateX(-50%) scale(1)';
    });
